...
feature "As the site owner, I want to add a portfolio item so that I can show off my work" do
  scenario "adding a new project" do
    ...
    fill_in 'Name', :with => 'Derik Strattan Portfolio'
    fill_in 'Technologies used', :with => 'Rails, Ruby, Bootstrap, HTML5, CSS3'
    click_on 'Create Project'
    page.text.must_include 'Project has been added'
    page.text.must_include 'Derik Strattan Portfolio'
...
# Given invalid project data is entered in a form
  visit new_project_path fill_in "Name", with: "Q"

# When the form is submitted with a short name and missing
  technologies_used field click_on "Create Project"
